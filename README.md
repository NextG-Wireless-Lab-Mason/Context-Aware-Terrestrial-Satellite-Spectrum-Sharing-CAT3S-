...
3. Run the rest_server.py which will send the necessary information to the simulator.py. Additionally to create the Environment of the DSA framework, access all the information from the DSA folder of the "Context-aware-Spectrum-Coexistence-Analyzer" [1].
