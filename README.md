...
2. Run the rest_server.py which will send the necessary information to the simulator.py. To create the Environment for the DSA framework access all the information from the DSA folder of the Context-aware-Spectrum-Coexistence-Analyzer. URL: https://github.com/NextG-Wireless-Lab-Mason/Context-aware-Spectrum-Coexistence-Analyzer.
